...
3. Управление:
   1) В любой момент игры пользователь иожет нажать Esc, чтобы закрыть игру
   2) В главном меню можно выбрать уровень, используя цифры и нажать пробел, чтобы начать игру
